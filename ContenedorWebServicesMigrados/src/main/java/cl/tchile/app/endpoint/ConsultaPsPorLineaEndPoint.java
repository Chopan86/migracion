...
import cl.tchile.app.helper.ConsultaPsPorLineaHelper;
...
public class ConsultaPsPorLineaEndPoint {
	...
	/** The consultaPsPorLineaHelper. */
	@Autowired
	ConsultaPsPorLineaHelper consultaPsPorLineaHelper;
...
//		com.response.awps01wi.awps01ws.ProgramInterface response = new com.response.awps01wi.awps01ws.ProgramInterface();
		...
		com.response.awps01wi.awps01ws.ProgramInterface response = consultaPsPorLineaHelper.setResponseConsultaPsPorLinea();
